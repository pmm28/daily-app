  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-6 py-12 text-center relative z-[1]">
      <div className="max-w-md w-full animate-rise">
        {/* Logo */}
        <div className="inline-flex items-center justify-center w-20 h-20 rounded-3xl mb-8 bg-gradient-to-br from-rose to-rose-mid shadow-lg shadow-rose-mid/20">
          <BookOpen size={36} className="text-white" />
        </div>

        {/* Headline */}
        <h1 className="font-serif text-6xl font-normal text-ink mb-2 tracking-tight">
          D<em className="italic text-rose-deep">aily</em>
        </h1>
